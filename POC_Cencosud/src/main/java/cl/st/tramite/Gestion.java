...
public class Gestion implements Serializable {
	...
	private void init() {
		...
		bpmsVO.setDeploymentId("cencosud:Remuneraciones:1.0");
		//bpmsVO.setProcessDef("METELASMANOS.pruebita");
		bpmsVO.setProcessDef("Remuneraciones.Calculo");
		...
		try {
			recuperaNombre = this.jBPMClient.getVariableFromProcess(bpmsVO.getDeploymentId(), bpmsVO.getUsername(), bpmsVO.getPassword(), this.getIdProceso(), "remun");
